    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-2">
        <div className="flex items-center gap-3 flex-wrap min-w-0 flex-1">
          <div className={cls("font-semibold text-slate-900", compact ? "text-sm" : "text-base")}>
            {it.nome_cliente || "—"}
          </div>
          <StatusColumn 
            status={statusLabel} 
        ...
        <div className="shrink-0">
          ...
          <Link
            ...
            prefetch={false}
            className={cls(
              "inline-flex items-center gap-1 rounded-lg border px-2 py-1 text-[11px] font-medium whitespace-nowrap",
      ...
      <div className="space-y-2">
        {/* Número do Processo */}
        <div className={cls("text-slate-600", compact ? "text-xs" : "text-sm")}>
          <span className="text-slate-500">Proc.:</span>{" "}
          <span className="font-semibold text-slate-900">{numeroProc || "—"}</span>
        </div>

        {/* Informações em grid */}
        <div className={cls("grid grid-cols-2 gap-x-4 gap-y-1", compact ? "text-[11px]" : "text-xs")}>
          {comarcaUF && (
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-none px-4 pb-24 pt-3 sm:px-6 lg:px-8">
        ...
        <section className="md:hidden space-y-2">
          ...
          {!loading && !isCompactTable && pageItems.map((it)=> (
              ...
              <table className="min-w-full text-xs">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr className="text-left text-slate-600">
                    ...
                    <th className="px-2 py-2 font-semibold whitespace-nowrap">Resultado</th>
                    <th className="px-2 py-2 font-semibold whitespace-nowrap text-right">Valor Hoje</th>
                    <th className="px-2 py-2 font-semibold whitespace-nowrap text-right">Valor Futuro</th>
                    <th className="px-2 py-2 font-semibold whitespace-nowrap">Ações</th>
                  </tr>
                </thead>
                <tbody>
                  {pageItems.map((it) => {
                    ...
                    return (
                      <tr 
                        ...
                        className={cls(
                          ...
                          awaiting ? "bg-amber-50/70" : "odd:bg-white even:bg-slate-50"
                        )}
                      >
                        <td className="px-2 py-2 font-medium text-slate-900 whitespace-nowrap">{it.id}</td>
                        <td className="px-2 py-2">
                          <div className="max-w-[150px] truncate" title={it.nome_cliente || ""}>
                            {it.nome_cliente || "—"}
                          </div>
                        </td>
                        ...
                        <td className="px-2 py-2 whitespace-nowrap">
                          <span className={cls("inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium ring-1 ring-inset", pillCls)}>
                            {resLabel}
                          </span>
                        </td>
                        ...
                        <td className="px-2 py-2 whitespace-nowrap">
                          <Link
                            ...
                            className={cls(
                              ...
                              awaiting ? "border-amber-300 bg-amber-50 text-amber-800" : "border-slate-300 bg-white text-slate-700"
                            )}
                          >
